package com.monitora.aulamicroservices.security.token.converter;
...
public class TokenConverter {
    ...
    public String decryptToken(String encryptedToken) {
        ...
        DirectDecrypter jweDecrypter = new DirectDecrypter(jwtConfiguration.getPrivateKey().getBytes());
